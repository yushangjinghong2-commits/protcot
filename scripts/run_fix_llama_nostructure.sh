#!/bin/bash
# FIX: Llama3-8B + saves/Llama/lora/sft + no_structure
# 修正 GPU1 Group A 的 model-LoRA 错误匹配
...
LORA="/home/aiscuser/jxlei/LlamaFactory/saves/Llama/lora/sft"

EXPERIMENTS=(
    "$LLAMA|$LORA/checkpoint-15000|$DS_NOSTRUCTURE|llama3-llamaft-ck15000-nostructure"
    "$LLAMA|$LORA/checkpoint-25000|$DS_NOSTRUCTURE|llama3-llamaft-ck25000-nostructure"
    "$LLAMA|$LORA/checkpoint-35000|$DS_NOSTRUCTURE|llama3-llamaft-ck35000-nostructure"
)

TOTAL=${#EXPERIMENTS[@]}; PASS=0; FAIL=0; FAILED_NAMES=()
echo "=========================================="; echo "FIX - Llama3-8B llamaft nostructure | Total: $TOTAL"; echo "=========================================="
