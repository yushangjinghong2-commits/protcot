#!/bin/bash
# Llama3-8B + saves/Llama/lora/sft + rag-no_structure
...
EXPERIMENTS=(
    "$LLAMA|$LORA/checkpoint-15000|$DS_RAG_NOSTRUCTURE|llama3-llamaft-ck15000-rag-nostructure"
    "$LLAMA|$LORA/checkpoint-25000|$DS_RAG_NOSTRUCTURE|llama3-llamaft-ck25000-rag-nostructure"
    "$LLAMA|$LORA/checkpoint-35000|$DS_RAG_NOSTRUCTURE|llama3-llamaft-ck35000-rag-nostructure"
)

TOTAL=${#EXPERIMENTS[@]}; PASS=0; FAIL=0; FAILED_NAMES=()
echo "=========================================="; echo "Llama3-8B llamaft rag-nostructure | Total: $TOTAL"; echo "=========================================="
